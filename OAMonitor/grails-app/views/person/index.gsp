       ...
       <div class="col-lg-12">
         ...
         <g:if test="${hits}" >
           <div class="paginateButtons" style="text-align:center">
             ...
             <br/>
             <span><g:paginate controller="person" action="index" params="${params}" next="Next" prev="Prev" total="${totalHits}" /></span>
           ...
           <table class="table table-striped">
             ...
             <tbody>
               <g:each in="${hits}" var="o">
                 <tr>
                   <td><g:link controller="person" action="show" id="${o.id}">${o.name}</g:link></td>
                 </tr>
               </g:each>
             </tbody>
           </table>
