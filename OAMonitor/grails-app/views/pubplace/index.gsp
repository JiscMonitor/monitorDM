...
<html>
  ...
  <body>
   ...
   <div class="container">
     <div class="row">
       <div class="col-lg-12">
         <h1>Publication Place Search</h1>
       </div>
     </div>
     <div class="row">
       <div class="col-lg-12">
         ...
         <g:if test="${hits}" >
           <div class="paginateButtons" style="text-align:center">
             ...
             <br/>
             <span><g:paginate controller="pubplace" action="index" params="${params}" next="Next" prev="Prev" total="${totalHits}" /></span>
           ...
           <table class="table table-striped">
             <thead> 
               <tr>
                 <th>Publication Endpoint</th>
               </tr>
             </thead>
             <tbody>
               <g:each in="${hits}" var="o">
                 <tr>
                   <td><g:link controller="pubplace" action="show" id="${o.id}">${o.name}</g:link></td>
                 </tr>
               </g:each>
             </tbody>
           </table>
